  ...
  template: `
    <main class="flex min-h-dvh w-full bg-[#efecff]">
      ...
      >
        ...
        <article
          class="col-span-2 grid w-full grid-cols-2 gap-x-10 gap-y-4 overflow-auto rounded-[18px] bg-white p-6 shadow-md"
        >
          @for (
            ...
            <div
              class="col-span-2 flex flex-col justify-between rounded-xl border border-gray-300 sm:col-span-1 w-full pb-4"
              data-testid="tarjeta-categoria"
            >
              <div class="sm:max-h-3/5 max-h-1/2">
                <figure class="h-full overflow-hidden border-b border-gray-300">
                  <img
              ...
              <button
                class="h-10 mx-auto cursor-pointer rounded-2xl bg-indigo-400 px-4 text-white hover:bg-indigo-500"
