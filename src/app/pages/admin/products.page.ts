...
@Component({
  imports: [Navegacion, Formulario, Presentation],
  template: `
    <div class="bg-[#efecff] w-full flex min-h-dvh">
      ...
      <div class="grid grid-cols-5 grid-rows-4 gap-4 p-6 w-full border-l border-[#d0c9fe]">
        <presentation titulo="Productos y catálogo" class="col-span-5"></presentation>
        ...
        >
          ...
          >
            <div class="bg-white   flex flex-col w-[240px]">
              ...
              >
                <p class="text-sm text-gray-400">Velas artesanales</p>
                <h3 class="text-lg font-semibold ">Vela de Postre</h3>
                <p class="text-md font-bold mt-2">$ 6.99</p>
