          ...
          >
            <thead>
              <tr class="border-y-[2px] border-[#f3f5f7] bg-[#f3f5f7]">
                <th class="py-2 p-1 text-center">N. venta</th>
                <th class="py-2 p-1 text-center">Fecha</th>
                <th class="py-2 p-1 text-center">Cliente</th>
                <th class="py-2 p-1 text-center">Producto</th>
                <th class="py-2 p-1 text-center">Categoría</th>
                <th class="py-2 text-center p-1">Monto</th>
                <th class="py-2 text-center p-1">Estado</th>
